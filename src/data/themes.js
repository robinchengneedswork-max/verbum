...
const SKIN_VARS={
  ...
  // ── B1/B2 new skins ──
  stainedglass:{'--col-bg':'#05020E','--col-border':'#2A1260','--col-active-bg':'#0E0622','--col-active-border':'#8B3FFF','--col-correct-bg':'#0A0A00','--col-correct-border':'#FFB830','--tile-hot-bg':'linear-gradient(160deg,#1A0A40,#3A0A60)','--tile-hot-border':'#FF6030','--tile-hot-shadow':'rgba(255,96,48,0.5)','--tile-hot-color':'#FFF0C0'},
  olivegrove:{'--col-bg':'#080C04','--col-border':'#2A3614','--col-active-bg':'#101A08','--col-active-border':'#8DB870','--col-correct-bg':'#0C1408','--col-correct-border':'#C8D890','--tile-hot-bg':'linear-gradient(160deg,#283820,#40582C)','--tile-hot-border':'#A8C870','--tile-hot-shadow':'rgba(168,200,112,0.4)','--tile-hot-color':'#F0F8D8'},
  mountsinai:{'--col-bg':'#0A0A0C','--col-border':'#2C2A30','--col-active-bg':'#141218','--col-active-border':'#FFD700','--col-correct-bg':'#080A0C','--col-correct-border':'#B0C8E0','--tile-hot-bg':'linear-gradient(160deg,#1A1820,#2A2030)','--tile-hot-border':'#FFD700','--tile-hot-shadow':'rgba(255,215,0,0.55)','--tile-hot-color':'#FFFFF0'},
  jordanriver:{'--col-bg':'#020810','--col-border':'#0C2840','--col-active-bg':'#060F1E','--col-active-border':'#3A9BD5','--col-correct-bg':'#020C08','--col-correct-border':'#70D8A8','--tile-hot-bg':'linear-gradient(160deg,#0C2040,#183C5A)','--tile-hot-border':'#5AC0E8','--tile-hot-shadow':'rgba(90,192,232,0.45)','--tile-hot-color':'#D8F4FF'},
  lilyvalley:{'--col-bg':'#040C04','--col-border':'#183018','--col-active-bg':'#081408','--col-active-border':'#D8E8B0','--col-correct-bg':'#040C04','--col-correct-border':'#F0FFC0','--tile-hot-bg':'linear-gradient(160deg,#183818,#285828)','--tile-hot-border':'#E8F8C8','--tile-hot-shadow':'rgba(232,248,200,0.5)','--tile-hot-color':'#FFFFFF'},
  alabaster:{'--col-bg':'#100C04','--col-border':'#482E10','--col-active-bg':'#1C1408','--col-active-border':'#D4A840','--col-correct-bg':'#100E04','--col-correct-border':'#E8D090','--tile-hot-bg':'linear-gradient(160deg,#3A2A10,#5A3E18)','--tile-hot-border':'#ECC86A','--tile-hot-shadow':'rgba(236,200,106,0.45)','--tile-hot-color':'#FFF8E8'},
  morningstar:{'--col-bg':'#020408','--col-border':'#0A1030','--col-active-bg':'#06081A','--col-active-border':'#FFD700','--col-correct-bg':'#020408','--col-correct-border':'#A8D8FF','--tile-hot-bg':'linear-gradient(160deg,#080C28,#101840)','--tile-hot-border':'#FFD700','--tile-hot-shadow':'rgba(255,215,0,0.7)','--tile-hot-color':'#FFFFF8'},
